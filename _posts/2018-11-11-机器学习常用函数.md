...
- [一.数据处理工具pandas和numpy](#一数据处理工具pandas和numpy)
  - [1.1 pandas读取数据](#11-pandas读取数据)
  - [1.2 numpy.random 生成数据的用法](#12-numpyrandom-生成数据的用法)
  - [1.3 pandas_profiling](#13-pandas_profiling)
  - [1.4 pandas去掉重复项 df.drop_duplicates()](#14-pandas去掉重复项-dfdrop_duplicates)
  - [1.5 pandas中loc和iloc区别](#15-pandas中loc和iloc区别)
  - [1.8 计算特征之间的相关系数](#18-计算特征之间的相关系数)
  - [1.9 dataframe的拼接](#19-dataframe的拼接)
  - [1.10  groupby的使用](#110-groupby的使用)
  - [1.11  Series.apply](#111-seriesapply)
  - [1.12  Series可以直接用于2个列相加减](#112-series可以直接用于2个列相加减)
- [二.绘图查看数据分布——seaborn和matplotlib](#二绘图查看数据分布seaborn和matplotlib)
  - [2.1 频数分布直方图](#21-频数分布直方图)
  - [2.2 散点图](#22-散点图)
  - [2.3 直线图](#23-直线图)
  - [2.4 双变量分布图](#24-双变量分布图)
  - [2.5 多变量两两之间的分布图](#25-多变量两两之间的分布图)
  - [2.6 热度图](#26-热度图)
- [三.机器学习包sklearn](#三机器学习包sklearn)
  - [3.1 划分数据集](#31-划分数据集)
  - [3.2 特征标准化](#32-特征标准化)
    - [3.2.1 第一种](#321-第一种)
    - [3.2.2 第二种](#322-第二种)
  - [3.3 交叉验证——查验模型稳定性](#33-交叉验证查验模型稳定性)
  - [3.4 模型评估方式——混淆矩阵](#34-模型评估方式混淆矩阵)
  - [3.5 分类结果展示（准确性，召回率，f1-score）](#35-分类结果展示准确性召回率f1-score)
  - [3.6 模型的保存和加载](#36-模型的保存和加载)
  - [3.7 数据样本不均衡——SMOTEENN](#37-数据样本不均衡smoteenn)
  - [3.8 自动超参调节](#38-自动超参调节)
    - [3.8.1 自动调参——GridSearchCV](#381-自动调参gridsearchcv)
    - [3.8.2 自动调参神器——Hyperopt](#382-自动调参神器hyperopt)
  - [3.9 to_categorical](#39-to_categorical)
  - [3.10 绘制ROC曲线](#310-绘制roc曲线)
- [四.分类模型](#四分类模型)
  - [4.1 随机森林](#41-随机森林)
  - [4.2.Xgboost](#42xgboost)
  - [4.3 SVM](#43-svm)
- [五.聚类模型](#五聚类模型)
  - [5.1.轮廓系数](#51轮廓系数)
